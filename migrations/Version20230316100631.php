 ...
 */
final class Version20230316100631 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bateau_proposer (bateau_id INT NOT NULL, proposer_id INT NOT NULL, INDEX IDX_8E70AE3FB13FA634 (proposer_id), INDEX IDX_8E70AE3FA9706509 (bateau_id), PRIMARY KEY(bateau_id, proposer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE equipement_contenir (equipement_id INT NOT NULL, contenir_id INT NOT NULL, INDEX IDX_234043D9806F0F5C (equipement_id), INDEX IDX_234043D91982B715 (contenir_id), PRIMARY KEY(equipement_id, contenir_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
